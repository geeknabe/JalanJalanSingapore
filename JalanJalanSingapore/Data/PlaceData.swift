...
let placesData: [Place] = [
    Place(
        id: 1,
        image: "Botanic-Gardens-Singapore",
        ...
        """,
        link: "https://www.nparks.gov.sg/sbg"
    ),
    Place(
        id: 2,
        image: "Gardens-by-the-Bay-Singapore",
    ...
    Place(
        ...
        """,
        link: "https://www.visitsingapore.com/en_my/see-do-singapore/recreation-leisure/viewpoints/merlion-park/"
    ),
    Place(
        id: 5,
        image: "Sentosa-Island-Singapore",
        name: "Sentosa Island",
        description: """
        Sentosa is Asia’s leading leisure destination and Singapore’s premier island resort getaway, located within 15 minutes from the central business and shopping districts. The island resort is managed by Sentosa Development Corporation, which works with various stakeholders to oversee property investments, attractions development, operation of the various leisure offerings and management of the residential precinct on the island. The Corporation also owns Mount Faber Leisure Group which runs Singapore’s only cable car service.
